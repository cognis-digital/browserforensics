...
[![PyPI](https://img.shields.io/pypi/v/cognis-browserforensics.svg)](https://pypi.org/project/cognis-browserforensics/)
[![CI](https://github.com/cognis-digital/browserforensics/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/browserforensics/actions)
...
BROWSERFORENSICS exists for one job — analyze exported browser history/downloads for iocs and exfil signs — and does it without a SaaS bill or heavyweight setup.
...
browserforensics scan .                      # scan the current project
browserforensics scan . --format json
browserforensics scan . --fail-on high       # non-zero exit for CI gates
browserforensics mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **Hindsight**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`browserforensics` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
