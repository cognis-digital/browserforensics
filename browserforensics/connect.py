"""Native cognis-connect emit for browserforensics — forward findings to any platform.

Maps browserforensics's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    browserforensics ... --format json | browserforensics-emit --to stix
    browserforensics-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
