"""BROWSERFORENSICS core — Analyze exported browser history/downloads for IOCs and exfil signs."""
...
RULES = [
    ("BRO-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("BRO-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("BRO-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
