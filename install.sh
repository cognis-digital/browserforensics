#!/usr/bin/env sh
# Universal installer for browserforensics. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/browserforensics.git"
echo "Installing browserforensics ..."
...
echo "Done. Run: browserforensics --help"
